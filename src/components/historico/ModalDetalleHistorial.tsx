        ...
        <div className="fixed inset-0 z-[100] bg-gray-50/95 backdrop-blur-sm flex flex-col animate-in slide-in-from-bottom-4 duration-300">
            ...
            <div className="flex-1 overflow-y-auto">
                {cargandoDetalle ? (
                    ...
                    <form id="form-historial" onSubmit={handleSubmit} className="p-4 md:p-8 max-w-7xl mx-auto pb-32 space-y-6 lg:space-y-8 w-full">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
                            ...
                            {/* COLUMNA DERECHA (Datos Capturados) */}
                            <div className="space-y-6 flex flex-col h-full">
