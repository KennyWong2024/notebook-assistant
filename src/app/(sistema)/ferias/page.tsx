...
import FeriaCard from "@/components/ferias/FeriaCard";
import FeriaFormModal from "@/components/ferias/FeriaFormModal";
        ...
        <div className="p-4 md:p-8 max-w-7xl mx-auto">
            ...
            <div className="flex space-x-2 mb-8 border-b border-gray-200">
                <button
                    ...
                    className={`pb-4 px-2 text-sm font-bold border-b-2 transition-colors ${activeTab === 'activas' ? 'border-red-600 text-red-600' : 'border-transparent text-gray-400 hover:text-gray-600'}`}
                >
                    En curso y Próximas
                </button>
                <button
                    onClick={() => setActiveTab('pasadas')}
                    className={`pb-4 px-2 text-sm font-bold border-b-2 transition-colors ${activeTab === 'pasadas' ? 'border-gray-800 text-gray-900' : 'border-transparent text-gray-400 hover:text-gray-600'}`}
                >
                    Finalizadas
                </button>
            </div>
            ...
            {loading ? (
                ...
                <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-12 flex flex-col items-center justify-center text-center">
                    ...
                    <h3 className="text-lg font-bold text-gray-900">No hay ferias en esta sección</h3>
                    <p className="text-gray-500 mt-1 text-sm">Prueba buscando en la otra pestaña o crea una nueva.</p>
                </div>
            ) : (
